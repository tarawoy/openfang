...
use openfang_types::model_catalog::{
    ...
    LMSTUDIO_BASE_URL, MINIMAX_BASE_URL, MISTRAL_BASE_URL, MOONSHOT_BASE_URL,
...
fn builtin_models() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        ModelCatalogEntry {
            ...
            display_name: "Llama 3.1 70B Instruct (NIM)".into(),
            provider: "nim".into(),
            tier: ModelTier::Smart,
            context_window: 131_072,
            max_output_tokens: 8_192,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["nim".into(), "nvidia-nim".into()],
        },
        ModelCatalogEntry {
            id: "meta/llama-3.1-405b-instruct".into(),
            display_name: "Llama 3.1 405B Instruct (NIM)".into(),
            provider: "nim".into(),
            tier: ModelTier::Frontier,
            context_window: 131_072,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            ...
            display_name: "Nemotron 70B Instruct (NIM)".into(),
            provider: "nim".into(),
            tier: ModelTier::Smart,
            context_window: 131_072,
            max_output_tokens: 8_192,
