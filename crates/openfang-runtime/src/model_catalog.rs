...
impl ModelCatalog {
    ...
    /// Merge dynamically discovered models from a provider endpoint.
    ///
    /// Adds models not already in the catalog with zero cost.
    /// Local providers get `Local` tier; remote providers default to `Balanced`.
    ...
    pub fn merge_discovered_models(&mut self, provider: &str, model_ids: &[String]) {
        ...
        for id in model_ids {
            ...
            let tier = if matches!(provider, "ollama" | "vllm" | "lmstudio") {
                ModelTier::Local
            } else {
                ModelTier::Balanced
            };
...
fn builtin_models() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        // ══════════════════════════════════════════════════════════════
        // Ollama (16) — local + cloud + dynamic discovery
        // ══════════════════════════════════════════════════════════════
        ModelCatalogEntry {
            id: "llama3.2".into(),
        ...
        // Ollama Cloud presets (`:cloud`)
        ModelCatalogEntry {
            id: "glm-5:cloud".into(),
            display_name: "GLM-5 (Ollama Cloud)".into(),
            provider: "ollama".into(),
            tier: ModelTier::Frontier,
            context_window: 128_000,
            max_output_tokens: 8_192,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["ollama-cloud".into()],
        },
        ModelCatalogEntry {
            id: "llama3.3:cloud".into(),
            display_name: "Llama 3.3 (Ollama Cloud)".into(),
            provider: "ollama".into(),
            tier: ModelTier::Frontier,
            context_window: 128_000,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            id: "qwen3:cloud".into(),
            display_name: "Qwen 3 (Ollama Cloud)".into(),
            provider: "ollama".into(),
            tier: ModelTier::Smart,
            context_window: 128_000,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            id: "deepseek-r1:cloud".into(),
            display_name: "DeepSeek R1 (Ollama Cloud)".into(),
            provider: "ollama".into(),
            tier: ModelTier::Frontier,
            context_window: 128_000,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            id: "gemma3:cloud".into(),
            display_name: "Gemma 3 (Ollama Cloud)".into(),
            provider: "ollama".into(),
            tier: ModelTier::Balanced,
            context_window: 128_000,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            id: "kimi-k2:cloud".into(),
            display_name: "Kimi K2 (Ollama Cloud)".into(),
            provider: "ollama".into(),
            tier: ModelTier::Smart,
            context_window: 128_000,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            id: "minimax-m2:cloud".into(),
            display_name: "MiniMax M2 (Ollama Cloud)".into(),
            provider: "ollama".into(),
            tier: ModelTier::Smart,
            context_window: 128_000,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            id: "minimax-m2.1:cloud".into(),
            display_name: "MiniMax M2.1 (Ollama Cloud)".into(),
            provider: "ollama".into(),
            tier: ModelTier::Smart,
            context_window: 128_000,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            ...
            display_name: "MiniMax M2.5 (Ollama Cloud)".into(),
            provider: "ollama".into(),
            tier: ModelTier::Frontier,
            context_window: 128_000,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            id: "minimax-m2.7:cloud".into(),
            display_name: "MiniMax M2.7 (Ollama Cloud)".into(),
            provider: "ollama".into(),
            tier: ModelTier::Frontier,
            context_window: 128_000,
            max_output_tokens: 8_192,
